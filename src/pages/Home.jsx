...
export default function Home() {
  ...
  return (
    <div className={`min-h-screen ${isDark ? 'bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950' : 'bg-gradient-to-br from-gray-50 to-white'} relative overflow-hidden`}>
      
      {/* 🎃 EFECTOS DE HUMO Y HALLOWEEN - FONDO GLOBAL */}
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        {/* Efectos de fondo originales */}
        ...
        {/* NUBES DE HUMO ANIMADAS */}
        <div className="absolute top-20 left-10 w-96 h-96 bg-gray-600/10 rounded-full blur-3xl animate-pulse" style={{animationDuration: '5s'}}></div>
        <div className="absolute top-40 right-20 w-80 h-80 bg-gray-700/10 rounded-full blur-3xl animate-pulse" style={{animationDuration: '7s', animationDelay: '1s'}}></div>
        <div className="absolute bottom-40 left-1/4 w-72 h-72 bg-gray-500/10 rounded-full blur-3xl animate-pulse" style={{animationDuration: '6s', animationDelay: '3s'}}></div>
        <div className="absolute bottom-20 right-1/3 w-64 h-64 bg-gray-600/10 rounded-full blur-3xl animate-pulse" style={{animationDuration: '8s', animationDelay: '2s'}}></div>
        <div className="absolute top-1/2 left-1/2 w-96 h-96 bg-gray-700/5 rounded-full blur-3xl animate-pulse" style={{animationDuration: '9s', animationDelay: '4s'}}></div>
        
        {/* CALABAZAS Y ELEMENTOS HALLOWEEN FLOTANTES - SUTILES */}
        ...
        <div className="absolute bottom-[30%] left-[10%] text-3xl animate-bounce opacity-8" style={{animationDuration: '3.8s', animationDelay: '1.5s'}}>🕷️</div>
      ...
      <section className="relative overflow-hidden">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
          {/* Calabazas decorativas sutiles en el Hero */}
          ...
          <div className="text-center space-y-6 z-10 relative">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/30 rounded-full backdrop-blur-xl">
            ...
            <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto">
              Descubre las últimas tendencias en hoodies personalizadas. Diseños únicos que combinan comodidad y estilo.
            </p>

            <div className="flex flex-wrap gap-4 justify-center">
              <Link 
                to="/productos"
                className="px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl font-semibold hover:shadow-lg hover:shadow-purple-500/50 transform hover:scale-105 transition-all duration-300 flex items-center gap-2"
              >
      ...
      <section className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 z-10">
        ...
        <div className="max-w-4xl mx-auto space-y-8 relative z-10">
          ...
          <div className={`p-8 md:p-12 rounded-3xl ${isDark ? 'bg-slate-900/50 border border-slate-800' : 'bg-white border border-gray-200'} backdrop-blur-xl shadow-xl relative overflow-hidden`}>
            {/* Decoración Halloween interna sutil */}
            ...
            <div className={`text-lg md:text-xl leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-700'} space-y-6 relative z-10`}>
              <p className="text-center text-2xl md:text-3xl font-bold bg-gradient-to-r from-purple-500 to-pink-500 bg-clip-text text-transparent mb-6">
                Desde 2018, creando magia bordada
              </p>
              
              <p>
                En <span className="font-bold text-purple-500">Loyola</span>, transformamos tus ideas en <span className="font-bold text-purple-500">bordados personalizados de alta calidad</span>. Cada puntada cuenta una historia, cada diseño refleja tu personalidad única.
              </p>
              
              <p>
                Nos especializamos en <span className="font-semibold">hoodies, crew necks, poleras y gorras</span> confeccionadas con <span className="font-bold text-purple-500">algodón 100% boliviano</span> y elaboradas por artesanos locales con años de experiencia.
              </p>

              <p className="text-center text-xl md:text-2xl font-bold text-purple-500 my-8 py-4 border-y-2 border-purple-500/30">
                🧵 Algodón boliviano + Talento local = Calidad excepcional 🧵
              </p>

              <div className={`p-6 md:p-8 rounded-2xl ${isDark ? 'bg-purple-900/20 border border-purple-500/30' : 'bg-purple-50 border border-purple-200'} relative`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6">
                <div className={`p-6 rounded-xl ${isDark ? 'bg-slate-800/50' : 'bg-gray-50'}`}>
                  <h4 className={`font-bold text-lg mb-3 ${isDark ? 'text-purple-400' : 'text-purple-600'}`}>
                    ✨ Nuestra Promesa
                  </h4>
                ...
                <div className={`p-6 rounded-xl ${isDark ? 'bg-slate-800/50' : 'bg-gray-50'}`}>
                  <h4 className={`font-bold text-lg mb-3 ${isDark ? 'text-pink-400' : 'text-pink-600'}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { icon: Scissors, label: 'Bordados Premium', desc: 'Alta calidad garantizada', color: 'from-purple-500 to-pink-500' },
      ...
      {/* Banner Promocional */}
      <section className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 z-10">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-purple-600 via-pink-600 to-red-600 p-8 md:p-16">
          {/* Efectos decorativos */}
          ...
          <div className="relative z-10 grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <Link
                to="/ofertas"
                className="inline-flex items-center gap-2 px-8 py-4 bg-white text-purple-600 rounded-xl font-bold hover:shadow-2xl transform hover:scale-105 transition-all duration-300"
              >
                Comprar Ahora
                <ChevronRight className="w-5 h-5" />
              </Link>
